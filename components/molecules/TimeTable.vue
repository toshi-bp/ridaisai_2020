              ...
              <div class="time-table__body">
                ...
                >
                  <TimeTableBox
                    ...
                    :startTime="Sunday1311.startTime"
                    :endTime="Sunday1311.endTime"
                ...
                >
                  <TimeTableBox
                    ...
                    :name="SundayLB.name"
                    :startTime="SundayLB.startTime"
                    :endTime="SundayLB.endTime"
...
export default {
  ...
  computed: {
    ...
    Sunday1311 () {
      ...
      return StageList.filter(item => item.id > 9 && item.id < 14)
    },
    SundayLB () {
